...
const ProductDetails = () => {
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-12 gap-8 max-w-screen-lg mx-auto bg-white p-8 rounded-3xl -translate-y-[50%]">
                <div className="col-span-4 rounded-xl flex justify-center items-center bg-gray-500/20 p-10">
                    <img src={image_url} alt="" />
                </div>
                <div className="flex flex-col gap-3 justify-between items-start col-span-8">
